...
import { ArrowRight, Award, BarChart, CheckCircle, ChevronLeft, Globe, PenTool, Users, Zap } from "lucide-react";
import React from "react";

export function Casestudy() {
    return (
        <div className=" bg-primary/5 py-15 sm:py-[13%] lg:py-20">
            <SectionTitle headline="دراسة حالة مميزة" title="كيف ساعدنا شركة هورايزن للتقنية على زيادة مبيعاتها بنسبة 150%" />
                                ...
                                <div className="border rounded-lg bg-background/40 backdrop-blur-sm p-4 h-full">
                                    ...
                                    <div className="mt-4 flex justify-between">
                                        <div className="text-center">
                                            <div className="text-sm font-bold text-muted-foreground">20%</div>
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-background rounded-lg p-6 border">
                        ...
                        <p className="text-muted-foreground">
                            كانت شركة هورايزن للتقنية تعاني من ضعف في الهوية البصرية وعدم اتساقها عبر منصاتها المختلفة، مما أدى
                            إلى صعوبة في التعرف على العلامة التجارية وانخفاض في ثقة العملاء. كما كانت تواجه منافسة شديدة في سوق
                            التكنولوجيا المتنامي.
                        </p>
                    </div>
                    <div className="bg-background rounded-lg p-6 border">
                        <h3 className="text-lg font-bold mb-3 flex items-center">
                        ...
                        <p className="text-muted-foreground mb-4">
                            قمنا بتطوير هوية بصرية جديدة تمامًا تعكس قيم الشركة وتطلعاتها المستقبلية، مع التركيز على الابتكار
                            والموثوقية. شملت الهوية الجديدة:
                        </p>
                    ...
                    <div className="bg-background rounded-lg p-6 border">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                            {DataResults.map((item) => (
                                <article key={item.id} className="text-center p-3 bg-primary/5 rounded-lg">
                        ...
                        <p className="text-muted-foreground">
                            أدت الهوية البصرية الجديدة إلى تحول كبير في أداء الشركة، حيث أصبحت أكثر تميزًا وجاذبية للعملاء. كما
                            ساهمت في بناء ثقة أكبر مع العملاء الحاليين والمحتملين، مما انعكس إيجابًا على المبيعات والنمو.
                        </p>
                    </div>
                    <button className="w-full bg-primary text-white rounded-md py-2 hover:bg-primary/90">عرض دراسة الحالة كاملة</button>
                </div>
            </div>
        </div>
    )
...
export function Stories() {
    const DataStories = [
        ...
        },
        {
            ...
            solution: "تطوير موقع جديد بالكامل مع التركيز على سرعة التحميل وتجربة المستخدم",
            results: [
    ...
    return (
        <div className=" py-15 sm:py-[13%] lg:py-20">
            <SectionTitle headline="المزيد من دراسات الحالة" title="قصص نجاح أخرى" description="استكشف المزيد من المشاريع الناجحة التي ساعدنا فيها عملائنا على تحقيق أهدافهم" />
                    ...
                    >
                        <div className="p-6">
                            ...
                            <div className="space-y-4 mb-6">
                                <div>
                                    <h4 className="text-sm font-bold text-muted-foreground mb-1">المشكلة:</h4>
                                    <p>{caseStudy.problem}</p>
                                </div>
                                <div>
                                    <h4 className="text-sm font-bold text-muted-foreground mb-1">الحل:</h4>
                                    <p>{caseStudy.solution}</p>
                                </div>
                                <div>
                                    <h4 className="text-sm font-bold text-muted-foreground mb-1">النتائج:</h4>
...
export function Clients() {
    const DataClients = [
        {
            id: "1",
            icon: <Award />,
            description: "فريق ctrl p قدم لنا هوية بصرية مميزة ساعدتنا على التميز في سوق مزدحم بالمنافسين. النتائج تجاوزت توقعاتنا بكثير.",
            title: "أحمد الشمري",
        ...
        },
        {
            id: "2",
            icon: <Zap />,
            description: "استراتيجية التسويق الرقمي التي طورها فريق ctrl p ساعدتنا على زيادة مبيعاتنا بشكل كبير وتوسيع قاعدة عملائنا.",
            title: "سارة القحطاني",
        ...
        },
        {
            id: "3",
            icon: <Users />,
            description: "الموقع الجديد الذي طوره فريق ctrl p غير تجربة المستخدم بالكامل وساهم في زيادة التسجيلات في منصتنا بنسبة 85%.",
            title: "محمد العتيبي",
    ...
    return (
        <div className=" bg-primary/5 py-15 sm:py-[13%] lg:py-20">
            <SectionTitle headline="آراء العملاء" title="ماذا يقول عملاؤنا عن تجربتهم معنا" />
